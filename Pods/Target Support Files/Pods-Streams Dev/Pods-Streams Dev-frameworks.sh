...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Parchment-iOS11.3/Parchment.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SDWebImage-iOS11.3/SDWebImage.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftVideoBackground-iOS11.3/SwiftVideoBackground.framework"
